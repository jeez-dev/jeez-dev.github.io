...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function No(){return new Cn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Na(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Oo(){return new Cn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Na(),fragmentShader:`
	...
	`}function yf(s){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===Hr||c===Vr,u=c===Si||c===yi;if(l||u){let d=t.get(o);const f=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Do(s)),d=l?e.fromEquirectangular(o,d):e.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),d.texture;if(d!==void 0)return d.texture;{const p=o.image;return l&&p&&p.height>0||u&&p&&i(p)?(e===null&&(e=new Do(s)),d=l?e.fromEquirectangular(o):e.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),o.addEventListener("dispose",r),d.texture):null}}}return o}function i(o){let c=0;const l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function Ef(s){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&Gi("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Tf(s,t,e,n){const i={},r=new WeakMap;function a(d){const f=d.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let m=0,h=_.length;m<h;m++)t.remove(_[m])}f.removeEventListener("dispose",a),delete i[f.id];const p=r.get(f);p&&(t.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(d,f){return i[f.id]===!0||(f.addEventListener("dispose",a),i[f.id]=!0,e.memory.geometries++),f}function c(d){const f=d.attributes;for(const g in f)t.update(f[g],s.ARRAY_BUFFER);const p=d.morphAttributes;for(const g in p){const _=p[g];for(let m=0,h=_.length;m<h;m++)t.update(_[m],s.ARRAY_BUFFER)}}function l(d){const f=[],p=d.index,g=d.attributes.position;let _=0;if(p!==null){const y=p.array;_=p.version;for(let T=0,M=y.length;T<M;T+=3){const I=y[T+0],A=y[T+1],w=y[T+2];f.push(I,A,A,w,w,I)}}else if(g!==void 0){const y=g.array;_=g.version;for(let T=0,M=y.length/3-1;T<M;T+=3){const I=T+0,A=T+1,w=T+2;f.push(I,A,A,w,w,I)}}else return;const m=new(Dc(f)?kc:zc)(f,1);m.version=_;const h=r.get(d);h&&t.remove(h),r.set(d,m)}function u(d){const f=r.get(d);if(f){const p=d.index;p!==null&&f.version<p.version&&l(d)}else l(d);return r.get(d)}return{get:o,update:c,getWireframeAttribute:u}}function bf(s,t,e){let n;function i(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,p){s.drawElements(n,p,r,f*a),e.update(p,n,1)}function l(f,p,g){g!==0&&(s.drawElementsInstanced(n,p,r,f*a,g),e.update(p,n,g))}function u(f,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,g);let m=0;for(let h=0;h<g;h++)m+=p[h];e.update(m,n,1)}function d(f,p,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let h=0;h<f.length;h++)l(f[h]/a,p[h],_[h]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,_,0,g);let h=0;for(let y=0;y<g;y++)h+=p[y]*_[y];e.update(h,n,1)}}this.setMode=i,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function Af(s){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(e.calls++,a){case s.TRIANGLES:e.triangles+=o*(r/3);break;case s.LINES:e.lines+=o*(r/2);break;case s.LINE_STRIP:e.lines+=o*(r-1);break;case s.LINE_LOOP:e.lines+=o*r;break;case s.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function wf(s,t,e){const n=new WeakMap,i=new Zt;function r(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==d){let x=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var p=x;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let M=0;g===!0&&(M=1),_===!0&&(M=2),m===!0&&(M=3);let I=o.attributes.position.count*M,A=1;I>t.maxTextureSize&&(A=Math.ceil(I/t.maxTextureSize),I=t.maxTextureSize);const w=new Float32Array(I*A*4*d),R=new Nc(w,I,A,d);R.type=Qe,R.needsUpdate=!0;const E=M*4;for(let C=0;C<d;C++){const k=h[C],B=y[C],W=T[C],K=I*A*4*C;for(let V=0;V<k.count;V++){const J=V*E;g===!0&&(i.fromBufferAttribute(k,V),w[K+J+0]=i.x,w[K+J+1]=i.y,w[K+J+2]=i.z,w[K+J+3]=0),_===!0&&(i.fromBufferAttribute(B,V),w[K+J+4]=i.x,w[K+J+5]=i.y,w[K+J+6]=i.z,w[K+J+7]=0),m===!0&&(i.fromBufferAttribute(W,V),w[K+J+8]=i.x,w[K+J+9]=i.y,w[K+J+10]=i.z,w[K+J+11]=W.itemSize===4?i.w:1)}}f={count:d,texture:R,size:new ft(I,A)},n.set(o,f),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",a.morphTexture,e);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(s,"morphTargetBaseInfluence",_),c.getUniforms().setValue(s,"morphTargetInfluences",l)}c.getUniforms().setValue(s,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(s,"morphTargetsTextureSize",f.size)}return{update:r}}function Rf(s,t,e,n){let i=new WeakMap;function r(c){const l=n.render.frame,u=c.geometry,d=t.get(c,u);if(i.get(d)!==l&&(t.update(d),i.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),i.get(c)!==l&&(e.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;i.get(f)!==l&&(f.update(),i.set(f,l))}return d}function a(){i=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:a}}class Xc extends be{constructor(t,e,n,i,r,a,o,c,l,u=_i){if(u!==_i&&u!==Ti)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===_i&&(n=Yn),n===void 0&&u===Ti&&(n=Ei),super(null,i,r,a,o,c,u,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Ue,this.minFilter=c!==void 0?c:Ue,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const qc=new be,Fo=new Xc(1,1),Yc=new Nc,$c=new fh,Kc=new Vc,Bo=[],zo=[],ko=new Float32Array(16),Go=new Float32Array(9),Ho=new Float32Array(4);function Pi(s,t,e){const n=s[0];if(n<=0||n>0)return s;const i=t*e;let r=Bo[i];if(r===void 0&&(r=new Float32Array(i),Bo[i]=r),t!==0){n.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,s[a].toArray(r,o)}return r}function _e(s,t){if(s.length!==t.length)return!1;for(let e=0,n=s.length;e<n;e++)if(s[e]!==t[e])return!1;return!0}function ve(s,t){for(let e=0,n=t.length;e<n;e++)s[e]=t[e]}function zs(s,t){let e=zo[t];e===void 0&&(e=new Int32Array(t),zo[t]=e);for(let n=0;n!==t;++n)e[n]=s.allocateTextureUnit();return e}function Cf(s,t){const e=this.cache;e[0]!==t&&(s.uniform1f(this.addr,t),e[0]=t)}function Pf(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(_e(e,t))return;s.uniform2fv(this.addr,t),ve(e,t)}}function Lf(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(_e(e,t))return;s.uniform3fv(this.addr,t),ve(e,t)}}function If(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(_e(e,t))return;s.uniform4fv(this.addr,t),ve(e,t)}}function Df(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(_e(e,t))return;s.uniformMatrix2fv(this.addr,!1,t),ve(e,t)}else{if(_e(e,n))return;Ho.set(n),s.uniformMatrix2fv(this.addr,!1,Ho),ve(e,n)}}function Uf(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(_e(e,t))return;s.uniformMatrix3fv(this.addr,!1,t),ve(e,t)}else{if(_e(e,n))return;Go.set(n),s.uniformMatrix3fv(this.addr,!1,Go),ve(e,n)}}function Nf(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(_e(e,t))return;s.uniformMatrix4fv(this.addr,!1,t),ve(e,t)}else{if(_e(e,n))return;ko.set(n),s.uniformMatrix4fv(this.addr,!1,ko),ve(e,n)}}function Of(s,t){const e=this.cache;e[0]!==t&&(s.uniform1i(this.addr,t),e[0]=t)}function Ff(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(_e(e,t))return;s.uniform2iv(this.addr,t),ve(e,t)}}function Bf(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(_e(e,t))return;s.uniform3iv(this.addr,t),ve(e,t)}}function zf(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(_e(e,t))return;s.uniform4iv(this.addr,t),ve(e,t)}}function kf(s,t){const e=this.cache;e[0]!==t&&(s.uniform1ui(this.addr,t),e[0]=t)}function Gf(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(_e(e,t))return;s.uniform2uiv(this.addr,t),ve(e,t)}}function Hf(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(_e(e,t))return;s.uniform3uiv(this.addr,t),ve(e,t)}}function Vf(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(_e(e,t))return;s.uniform4uiv(this.addr,t),ve(e,t)}}function Wf(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Fo.compareFunction=Ic,r=Fo):r=qc,e.setTexture2D(t||r,i)}function Xf(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||$c,i)}function qf(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||Kc,i)}function Yf(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||Yc,i)}function $f(s){switch(s){case 5126:return Cf;case 35664:return Pf;case 35665:return Lf;case 35666:return If;case 35674:return Df;case 35675:return Uf;case 35676:return Nf;case 5124:case 35670:return Of;case 35667:case 35671:return Ff;case 35668:case 35672:return Bf;case 35669:case 35673:return zf;case 5125:return kf;case 36294:return Gf;case 36295:return Hf;case 36296:return Vf;case 35678:case 36198:case 36298:case 36306:case 35682:return Wf;case 35679:case 36299:case 36307:return Xf;case 35680:case 36300:case 36308:case 36293:return qf;case 36289:case 36303:case 36311:case 36292:return Yf}}function Kf(s,t){s.uniform1fv(this.addr,t)}function jf(s,t){const e=Pi(t,this.size,2);s.uniform2fv(this.addr,e)}function Jf(s,t){const e=Pi(t,this.size,3);s.uniform3fv(this.addr,e)}function Zf(s,t){const e=Pi(t,this.size,4);s.uniform4fv(this.addr,e)}function Qf(s,t){const e=Pi(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,e)}function tp(s,t){const e=Pi(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,e)}function ep(s,t){const e=Pi(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,e)}function np(s,t){s.uniform1iv(this.addr,t)}function ip(s,t){s.uniform2iv(this.addr,t)}function sp(s,t){s.uniform3iv(this.addr,t)}function rp(s,t){s.uniform4iv(this.addr,t)}function ap(s,t){s.uniform1uiv(this.addr,t)}function op(s,t){s.uniform2uiv(this.addr,t)}function cp(s,t){s.uniform3uiv(this.addr,t)}function lp(s,t){s.uniform4uiv(this.addr,t)}function hp(s,t,e){const n=this.cache,i=t.length,r=zs(e,i);_e(n,r)||(s.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==i;++a)e.setTexture2D(t[a]||qc,r[a])}function up(s,t,e){const n=this.cache,i=t.length,r=zs(e,i);_e(n,r)||(s.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==i;++a)e.setTexture3D(t[a]||$c,r[a])}function dp(s,t,e){const n=this.cache,i=t.length,r=zs(e,i);_e(n,r)||(s.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==i;++a)e.setTextureCube(t[a]||Kc,r[a])}function fp(s,t,e){const n=this.cache,i=t.length,r=zs(e,i);_e(n,r)||(s.uniform1iv(this.addr,r),ve(n,r));for(let a=0;a!==i;++a)e.setTexture2DArray(t[a]||Yc,r[a])}function pp(s){switch(s){case 5126:return Kf;case 35664:return jf;case 35665:return Jf;case 35666:return Zf;case 35674:return Qf;case 35675:return tp;case 35676:return ep;case 5124:case 35670:return np;case 35667:case 35671:return ip;case 35668:case 35672:return sp;case 35669:case 35673:return rp;case 5125:return ap;case 36294:return op;case 36295:return cp;case 36296:return lp;case 35678:case 36198:case 36298:case 36306:case 35682:return hp;case 35679:case 36299:case 36307:return up;case 35680:case 36300:case 36308:case 36293:return dp;case 36289:case 36303:case 36311:case 36292:return fp}}class mp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=$f(e.type)}}class gp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=pp(e.type)}}class _p{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let r=0,a=i.length;r!==a;++r){const o=i[r];o.setValue(t,e[o.id],n)}}}const xr=/(\w+)(\])?(\[|\.)?/g;function Vo(s,t){s.seq.push(t),s.map[t.id]=t}function vp(s,t,e){const n=s.name,i=n.length;for(xr.lastIndex=0;;){const r=xr.exec(n),a=xr.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===i){Vo(e,l===void 0?new mp(o,s,t):new gp(o,s,t));break}else{let d=e.map[o];d===void 0&&(d=new _p(o),Vo(e,d)),e=d}}}class Us{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=t.getActiveUniform(e,i),a=t.getUniformLocation(e,r.name);vp(r,a,this)}}setValue(t,e,n,i){const r=this.map[e];r!==void 0&&r.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let r=0,a=e.length;r!==a;++r){const o=e[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,r=t.length;i!==r;++i){const a=t[i];a.id in e&&n.push(a)}return n}}function Wo(s,t,e){const n=s.createShader(t);return s.shaderSource(n,e),s.compileShader(n),n}const xp=37297;let Mp=0;function Sp(s,t){const e=s.split(`
`),n=[],i=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=i;a<r;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const Xo=new Ut;function yp(s){qt._getMatrix(Xo,qt.workingColorSpace,s);const t=`mat3( ${Xo.elements.map(e=>e.toFixed(4))} )`;switch(qt.getTransfer(s)){case Bs:return[t,"LinearTransferOETF"];case Jt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[t,"LinearTransferOETF"]}}function qo(s,t,e){const n=s.getShaderParameter(t,s.COMPILE_STATUS),i=s.getShaderInfoLog(t).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const a=parseInt(r[1]);return e.toUpperCase()+`

`+i+`

`+Sp(s.getShaderSource(t),a)}else return i}function Ep(s,t){const e=yp(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Tp(s,t){let e;switch(t){case kl:e="Linear";break;case Gl:e="Reinhard";break;case Hl:e="Cineon";break;case Vl:e="ACESFilmic";break;case Xl:e="AgX";break;case ql:e="Neutral";break;case Wl:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+s+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Es=new P;function bp(){qt.getLuminanceCoefficients(Es);const s=Es.x.toFixed(4),t=Es.y.toFixed(4),e=Es.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Ap(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Hi).join(`
`)}function wp(s){const t=[];for(const e in s){const n=s[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Rp(s,t){const e={},n=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(t,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:s.getAttribLocation(t,a),locationSize:o}}return e}function Hi(s){return s!==""}function Yo(s,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function $o(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Cp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ma(s){return s.replace(Cp,Lp)}const Pp=new Map;function Lp(s,t){let e=Ot[t];if(e===void 0){const n=Pp.get(t);if(n!==void 0)e=Ot[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Ma(e)}const Ip=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ko(s){return s.replace(Ip,Dp)}function Dp(s,t,e,n){let i="";for(let r=parseInt(t);r<parseInt(e);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function jo(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}function Up(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===xc?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===xl?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===un&&(t="SHADOWMAP_TYPE_VSM"),t}function Np(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Si:case yi:t="ENVMAP_TYPE_CUBE";break;case Fs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Op(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case yi:t="ENVMAP_MODE_REFRACTION";break}return t}function Fp(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Mc:t="ENVMAP_BLENDING_MULTIPLY";break;case Bl:t="ENVMAP_BLENDING_MIX";break;case zl:t="ENVMAP_BLENDING_ADD";break}return t}function Bp(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function zp(s,t,e,n){const i=s.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=Up(e),l=Np(e),u=Op(e),d=Fp(e),f=Bp(e),p=Ap(e),g=wp(r),_=i.createProgram();let m,h,y=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+h);const T=y+m+a,M=y+h+o,I=Wo(i,i.VERTEX_SHADER,T),A=Wo(i,i.FRAGMENT_SHADER,M);i.attachShader(_,I),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(C){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),B=i.getShaderInfoLog(I).trim(),W=i.getShaderInfoLog(A).trim();let K=!0,V=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,I,A);else{const J=qo(i,I,"vertex"),H=qo(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,t.appendChild(this.root),this.cycleEl=this.root.querySelector('[data-el="cycle"]'),this.resEl=this.root.querySelector('[data-el="res"]'),this.alertEl=this.root.querySelector('[data-el="alerts"]'),this.chipEl=this.root.querySelector('[data-el="chip"]'),this.bannerEl=this.root.querySelector('[data-el="banner"]'),this.printBtn=this.root.querySelector('[data-el="print"]'),this.techEl=this.root.querySelector('[data-el="tech"]'),this.saveEl=this.root.querySelector('[data-el="save"]'),this.speedEls=[...this.root.querySelectorAll("[data-speed]")],this.speedEls.forEach(r=>r.onclick=()=>n.onSpeed(Number(r.dataset.speed))),this.root.querySelector('[data-el="gas"]').onclick=r=>{n.onToggleGas();const a=r.currentTarget;a.textContent=a.textContent?.includes("✓")?"Gas ✕":"Gas ✓"},this.root.querySelector('[data-el="help"]').onclick=()=>n.onToggleHelp(),this.printBtn.onclick=()=>n.onPrint();const i=this.root.querySelector('[data-el="toolbar"]');for(const r of Xm){const a=eo[r],o=document.createElement("button");o.className="tool build",o.dataset.build=r,o.title=`${a.label} — ${a.desc} (${fc(r)})`,o.innerHTML=`<span class="ic">${a.icon}</span><span class="cost">${fc(r)}</span>`,o.onclick=()=>this.setTool({kind:"build",station:r}),i.appendChild(o),this.buildEls.push(o)}this.toolEls=[...i.querySelectorAll(".tool")],this.root.querySelectorAll("[data-tool]").forEach(r=>{r.onclick=()=>this.setTool({kind:r.dataset.tool})}),window.addEventListener("keydown",r=>{if(r.repeat)return;const a=r.key.toLowerCase();if(a===" "){r.preventDefault(),this.actions.onSpeed(this.sim.speed===0?1:0);return}const o=Wm[a];o&&this.setTool(o)})}root;actions;tool={kind:"inspect"};lastHtmlUpdate=0;cycleEl;speedEls=[];resEl;alertEl;toolEls=[];buildEls=[];chipEl;bannerEl;printBtn;techEl;saveEl;setTool(t){this.tool=t,this.actions.onTool(t),this.refreshToolButtons()}refreshToolButtons(){for(const t of this.toolEls){let e=!1;t.dataset.tool&&this.tool.kind!=="build"&&(e=t.dataset.tool===this.tool.kind),t.dataset.build&&this.tool.kind==="build"&&(e=t.dataset.build===this.tool.station),t.classList.toggle("on",e)}}inspect(t,e,n){if(e==null&&!n){this.chipEl.classList.add("hidden");return}let i="";if(n){const r=n;i=`<div class="chipcard">
        ...
        <div class="bannerbtns"><button data-b="new">Try Again</button></div></div>`,this.bannerEl.querySelector('[data-b="new"]').onclick=()=>this.actions.onNewGame()):this.bannerEl.className="banner hidden";for(const c of this.buildEls){const l=c.dataset.build;c.classList.toggle("poor",!t.canAfford(l))}}}function hn(s,t,e,n){return`<span class="pill ${n}" title="${e}">${ya(s)} <b>${t}</b></span>`}function wr(s,t,e){return`<div class="bar"><span>${s}</span><div class="bartrack"><div style="width:${Math.max(0,Math.min(100,t))}%;background:${e}"></div></div></div>`}class Ym{constructor(t,e,n,i){this.renderer=e,this.sim=n,this.hud=i,this.marquee=document.createElement("div"),this.marquee.className="marquee hidden",document.body.appendChild(this.marquee),t.addEventListener("pointerdown",r=>this.onDown(r)),t.addEventListener("pointermove",r=>this.onMove(r)),t.addEventListener("pointerup",r=>this.onUp(r)),t.addEventListener("pointercancel",r=>this.onUp(r)),t.addEventListener("wheel",r=>this.onWheel(r),{passive:!1}),t.addEventListener("contextmenu",r=>r.preventDefault())}pointers=new Map;dragging=!1;dragStart=null;dragMoved=!1;pinchBase=0;isPinch=!1;marquee;panMode=!1;activeTool(){return this.hud.tool}onDown(t){if(t.target.setPointerCapture?.(t.pointerId),this.pointers.set(t.pointerId,{id:t.pointerId,x:t.clientX,y:t.clientY}),this.pointers.size===2){const e=[...this.pointers.values()];this.pinchBase=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y),this.isPinch=!0,this.hideMarquee(),this.dragging=!1;return}this.dragging=!0,this.dragMoved=!1,this.dragStart={x:t.clientX,y:t.clientY},this.panMode=t.button===1||t.button===2||this.activeTool().kind==="inspect"}onMove(t){const e=this.pointers.get(t.pointerId);if(!e)return;const n={x:e.x,y:e.y};if(e.x=t.clientX,e.y=t.clientY,this.isPinch&&this.pointers.size===2){const o=[...this.pointers.values()],c=Math.hypot(o[0].x-o[1].x,o[0].y-o[1].y);this.pinchBase>0&&c>0&&this.renderer.zoomBy(this.pinchBase/c,{x:(o[0].x+o[1].x)/2,y:(o[0].y+o[1].y)/2}),this.pinchBase=c;return}if(!this.dragging||!this.dragStart)return;const i=t.clientX-this.dragStart.x,r=t.clientY-this.dragStart.y;if(Math.abs(i)+Math.abs(r)>8&&(this.dragMoved=!0),this.panMode&&this.dragMoved){const o=this.renderer.clientToWorld(n.x,n.y),c=this.renderer.clientToWorld(e.x,e.y);o&&c&&this.renderer.panBy(o.x-c.x,o.y-c.y);return}const a=this.activeTool();(a.kind==="dig"||a.kind==="cancel")&&this.dragMoved&&this.showMarquee(this.dragStart,{x:t.clientX,y:t.clientY})}onUp(t){const e=this.pointers.get(t.pointerId);if(this.pointers.delete(t.pointerId),this.pointers.size<2&&(this.isPinch=!1),this.isPinch||!this.dragging)return;this.dragging=!1;const n=this.activeTool(),i=this.dragStart?this.renderer.clientToTile(this.dragStart.x,this.dragStart.y):null,r=this.renderer.clientToTile(t.clientX,t.clientY);if((n.kind==="dig"||n.kind==="cancel")&&this.dragMoved&&i&&r){n.kind==="dig"?this.sim.orderDigRect(i.x,i.y,r.x,r.y):this.sim.cancelRect(i.x,i.y,r.x,r.y),this.hideMarquee();return}if(this.hideMarquee(),this.dragMoved&&this.panMode||!e||!r||t.button!==0)return;const a=r.y*Rt+r.x;let o=this.sim.state.dupes.find(c=>c.alive&&c.cell===a)??null;switch(o||(o=this.sim.state.dupes.find(c=>{if(!c.alive)return!1;const l=Math.abs(c.cell%Rt-r.x),u=Math.abs(Math.floor(c.cell/Rt)-r.y);return l<=1&&u<=1})??null),n.kind){case"dig":this.sim.orderDigRect(r.x,r.y,r.x,r.y);break;case"cancel":this.sim.cancelRect(r.x,r.y,r.x,r.y);break;case"build":{const c=this.sim.placeBlueprint(n.station,r.x,r.y);c&&this.toast(c);break}case"inspect":default:this.hud.inspect(this.sim,a,o);break}}toast(t){const e=document.createElement("div");e.className="toast",e.textContent=t,document.body.appendChild(e),setTimeout(()=>e.classList.add("gone"),1300),setTimeout(()=>e.remove(),1900)}onWheel(t){t.preventDefault();const e=t.deltaY>0?1.12:.9;this.renderer.zoomBy(e,{x:t.clientX,y:t.clientY})}showMarquee(t,e){const n=Math.min(t.x,e.x),i=Math.min(t.y,e.y),r=Math.abs(t.x-e.x),a=Math.abs(t.y-e.y);Object.assign(this.marquee.style,{left:`${n}px`,top:`${i}px`,width:`${r}px`,height:`${a}px`}),this.marquee.classList.remove("hidden")}hideMarquee(){this.marquee.classList.add("hidden")}}const nl=document.getElementById("app");let zt=gl()??new pn(Date.now()%1e5|0);const Kn=new Vm(nl);let Ea=zt.state.cycle,pc=Date.now();const ks=new qm(nl,zt,{onTool:()=>{},onSpeed:s=>zt.setSpeed(s),onToggleGas:()=>{Rr=!Rr,Kn.setGasView(Rr)},onPrint:()=>zt.acceptPrint(),onResearch:s=>zt.setResearchGoal(s),onNewGame:()=>{Ta(),Xa(new pn(Date.now()%1e5|0))},onContinueEndless:()=>zt.continueEndless(),onToggleHelp:()=>Km()});let Rr=!0;const $m=new Ym(Kn.canvas,Kn,zt,ks);function Xa(s){zt=s,Ea=zt.state.cycle,ks.sim=zt,$m.sim=zt,Kn.centerOnTile(zt.xOf(zt.podCell),zt.yOf(zt.podCell)),il(),qa(),Ki(zt)}Kn.centerOnTile(zt.xOf(zt.podCell),zt.yOf(zt.podCell));const Ln=document.createElement("div");Ln.className="overlay"+(Lr(),"");Ln.innerHTML=`
  <div class="bannercard">
    ...
    <ul>
      <li><kbd>D</kbd> dig · <kbd>X</kbd> cancel · <kbd>1-8</kbd> build · <kbd>Space</kbd> pause</li>
      <li>Wheel / pinch — zoom · empty-drag — pan</li>
    </ul>
    <div class="bannerbtns">
      <button class="startbtn" data-a="go">${Lr()?"Continue Colony":"Found Colony"}</button>
      ${Lr()?'<button class="startbtn" data-a="new" style="background:rgba(42,45,58,.9);color:var(--ivory);border:1px solid var(--line)">New Colony</button>':""}
    </div>
  </div>`;document.body.appendChild(Ln);zt.setSpeed(0);function il(){Ln.classList.add("hidden"),zt.speed===0&&zt.setSpeed(1)}Ln.querySelector('[data-a="go"]').onclick=()=>il();const mc=Ln.querySelector('[data-a="new"]');mc&&(mc.onclick=()=>{Ta(),Xa(new pn(Date.now()%1e5|0))});const Pn=document.createElement("div");Pn.className="overlay hidden";Pn.innerHTML=Ln.innerHTML;document.body.appendChild(Pn);Pn.querySelector('[data-a="go"]').onclick=()=>qa();const gc=Pn.querySelector('[data-a="new"]');gc&&(gc.onclick=()=>{Ta(),Xa(new pn(Date.now()%1e5|0))});let sl=1;function Km(){Pn.classList.contains("hidden")?(sl=zt.speed,zt.setSpeed(0),Pn.classList.remove("hidden")):qa()}function qa(){Pn.classList.add("hidden"),zt.speed===0&&Ln.classList.contains("hidden")&&zt.setSpeed(sl||1)}function jm(){const s=Date.now();(zt.state.cycle!==Ea||s-pc>3e4)&&(Ea=zt.state.cycle,pc=s,ks.flashSaved(),Ki(zt))}document.addEventListener("visibilitychange",()=>{document.hidden&&Ki(zt)});window.addEventListener("beforeunload",()=>Ki(zt));let Cr=0,_c=performance.now(),Jm=0;function rl(s){const t=Math.min((s-_c)/1e3,.25);_c=s,Cr+=t;let e=0;for(;Cr>=Pr&&e++<40;)zt.tick(),Cr-=Pr;Kn.render(zt),ks.update(zt),++Jm%30===0&&jm(),requestAnimationFrame(rl)}requestAnimationFrame(rl);window.__oxybase={sim:()=>zt,renderer:Kn,save:()=>Ki(zt)};
