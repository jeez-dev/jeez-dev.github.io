...
`+e.vertexShader,e.vertexShader=e.vertexShader.replace("#include <begin_vertex>",`#include <begin_vertex>
  ...
  transformed += normal * wobble;`)},i.wobbleUniforms=t,i}function tl(i,t=!1){const e=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),r=new Set(Object.keys(i[0].morphAttributes)),s={},o={},a=i[0].morphTargetsRelative,l=new We;let c=0;for(let u=0;u<i.length;++u){const d=i[u];let f=0;if(e!==(d.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const p in d.attributes){if(!n.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+'. All geometries must have compatible attributes; make sure "'+p+'" attribute exists among all geometries, or in none of them.'),null;s[p]===void 0&&(s[p]=[]),s[p].push(d.attributes[p]),f++}if(f!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". Make sure all geometries have the same number of attributes."),null;if(a!==d.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const p in d.morphAttributes){if(!r.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+".  .morphAttributes must be consistent throughout all geometries."),null;o[p]===void 0&&(o[p]=[]),o[p].push(d.morphAttributes[p])}if(t){let p;if(e)p=d.index.count;else if(d.attributes.position!==void 0)p=d.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". The geometry must have either an index or a position attribute"),null;l.addGroup(c,p,u),c+=p}}if(e){let u=0;const d=[];for(let f=0;f<i.length;++f){const p=i[f].index;for(let g=0;g<p.count;++g)d.push(p.getX(g)+u);u+=i[f].attributes.position.count}l.setIndex(d)}for(const u in s){const d=el(s[u]);if(!d)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" attribute."),null;l.setAttribute(u,d)}for(const u in o){const d=o[u][0].length;if(d===0)break;l.morphAttributes=l.morphAttributes||{},l.morphAttributes[u]=[];for(let f=0;f<d;++f){const p=[];for(let M=0;M<o[u].length;++M)p.push(o[u][M][f]);const g=el(p);if(!g)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" morphAttribute."),null;l.morphAttributes[u].push(g)}}return l}function el(i){let t,e,n,r=-1,s=0;for(let c=0;c<i.length;++c){const u=i[c];if(t===void 0&&(t=u.array.constructor),t!==u.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(e===void 0&&(e=u.itemSize),e!==u.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=u.normalized),n!==u.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(r===-1&&(r=u.gpuType),r!==u.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;s+=u.count*e}const o=new t(s),a=new Le(o,e,n);let l=0;for(let c=0;c<i.length;++c){const u=i[c];if(u.isInterleavedBufferAttribute){const d=l/e;for(let f=0,p=u.count;f<p;f++)for(let g=0;g<e;g++){const M=u.getComponent(f,g);a.setComponent(f+d,g,M)}}else o.set(u.array,l);l+=u.count*e}return r!==void 0&&(a.gpuType=r),a}const fe=1,Ss=.94,yr=.6,$m=.22,jm=15265535,Jm=1840160,Qm=14257056,tg=16512230,nl=kn.degToRad(Kl),Gi=new I(0,Math.cos(nl),Math.sin(nl));function il(i,t,e,n,r=2){const s=new qn(i,t,e,r,r,r),o=s.attributes.position,a=i/2,l=t/2,c=e/2,u=Math.min(n,a,l,c),d=a-u,f=l-u,p=c-u;for(let g=0;g<o.count;g++){const M=o.getX(g),m=o.getY(g),h=o.getZ(g),A=kn.clamp(M,-d,d),T=kn.clamp(m,-f,f),y=kn.clamp(h,-p,p),N=M-A,w=m-T,b=h-y,D=Math.sqrt(N*N+w*w+b*b);if(D>1e-6){const S=u/D;o.setXYZ(g,A+N*S,T+w*S,y+b*S)}}return s.computeVertexNormals(),s}function qe(i,t){const e=new Ft(t),n=i.attributes.position.count,r=new Float32Array(n*3);for(let s=0;s<n;s++)r[s*3]=e.r,r[s*3+1]=e.g,r[s*3+2]=e.b;return i.setAttribute("color",new Le(r,3)),i}function Er(i,t,e){const n=new Pi().setFromUnitVectors(new I(0,1,0),e.clone().normalize());return i.applyQuaternion(n),i.translate(t.x,t.y,t.z),i}function rl(i,t){const e=[],n=[];for(const[O,J]of i){const nt=il(Ss,yr,Ss,$m);nt.translate(O*fe,yr/2,J*fe),e.push(qe(nt,t.body))}const[r,s]=i[0],o=i.reduce((O,[J,nt])=>[O[0]+J,O[1]+nt],[0,0]).map(O=>O/i.length),a=new It(r-o[0],s-o[1]);a.lengthSq()<1e-6&&a.set(0,-1),a.normalize();const l=fe*.32,c=new I(r*fe+a.x*fe*.4,yr*.92,s*fe+a.y*fe*.4),u=new fi(l,10,8);u.translate(c.x,c.y,c.z),e.push(qe(u,t.body));const d=new It(-a.y,a.x),f=l*1.5;for(const O of[-1,1]){const J=new wa(l*.62,f,6),nt=new I(c.x+d.x*l*.75*O+a.x*l*.3,c.y+l*.85,c.z+d.y*l*.75*O+a.y*l*.3);Er(J,nt,new I(a.x*.25+d.x*.15*O,1,a.y*.25+d.y*.15*O)),e.push(qe(J,t.accent))}const p=.55,g=.31,M=1.18;for(const O of[-1,1]){const J=new I(p*O,Gi.y,Gi.z).normalize(),nt=c.clone().add(J.clone().multiplyScalar(l*M)),ft=new fi(l*g,8,6);ft.translate(nt.x,nt.y,nt.z),n.push(qe(ft,jm));const Rt=nt.clone().add(J.clone().multiplyScalar(l*g*.85)),Xt=new fi(l*.16,6,5);Xt.translate(Rt.x,Rt.y,Rt.z),n.push(qe(Xt,Jm))}const m=new I(Gi.x,Gi.y*.82,Gi.z).normalize(),h=c.clone().add(m.clone().multiplyScalar(l*1.2)),A=new fi(l*.18,6,5);A.translate(h.x,h.y,h.z),e.push(qe(A,Qm));const T=new I(c.x+a.x*l*.9,c.y-l*.1,c.z+a.y*l*.9),y=l*1.3;for(const O of[-1,1])for(const J of[-.22,0,.22]){const nt=new _i(.008,.008,y,4);nt.translate(0,y/2,0);const ft=new I(d.x*O+a.x*.5,J,d.y*O+a.y*.5);Er(nt,T,ft),e.push(qe(nt,tg))}const N=new I(a.x,0,a.y).multiplyScalar(Ss/2+.06);for(const O of[-1,1]){const J=il(.3,.22,.26,.07);J.translate(r*fe+N.x+d.x*.24*O,.12,s*fe+N.z+d.y*.24*O),e.push(qe(J,t.body))}const w=a.clone().multiplyScalar(-1),b=new I(r*fe+w.x*fe*.54,yr*.4,s*fe+w.y*fe*.54),D=fe*.55,S=D*.55,x=new I(w.x*.85,.35,w.y*.85),R=new _i(.09,.12,S,6);R.translate(0,S/2,0),Er(R,b,x),e.push(qe(R,t.accent));const G=D*.5,z=new I(w.x*.3,.95,w.y*.3),W=b.clone().add(x.clone().normalize().multiplyScalar(S)),Y=new _i(.05,.09,G,6);Y.translate(0,G/2,0),Er(Y,W,z),e.push(qe(Y,t.accent));const V=tl(e,!1);V.computeBoundingSphere();const $=tl(n,!1);return $.computeBoundingSphere(),{geometry:V,eyeGeometry:$,anchorLocal:new It(r*fe,s*fe)}}const eg={omega:20,zeta:.85},sl={omega:15,zeta:.35},ng={omega:15,zeta:.85},Tr={omega:22,zeta:.55},ci={omega:18,zeta:.35},al={omega:11,zeta:.18},ig=1.55,rg=.16,Ar=.34,ol=.05,ll=.16,sg=.05,ag=.4,og=.6,lg=12,cl={omega:14,zeta:.5},Jl=1.7;function ha(i){const t=i.map(s=>s[0]),e=i.map(s=>s[1]),n=Math.max(...t)-Math.min(...t)+1,r=Math.max(...e)-Math.min(...e)+1;return Math.max(n,r)}function cg(i){return Math.min(1,Jl/ha(i))}class ug{root=new di;body=new di;mesh;eyes;material;posSpring;tiltX=new Ye(0);tiltZ=new Ye(0);scaleAlong=new Ye(1);scaleAcross=new Ye(1);scaleUp=new Ye(1);wobbleEnergy=new Ye(0);displayScale;posProfile=sl;target=new I;prevVelocity=new I;held=!1;inTray=!0;footprintDim=1;timeOffset=Math.random()*100;time=0;shadow;constructor(t,e,n){const{geometry:r,eyeGeometry:s}=rl(t,e);this.material=Km(),this.mesh=new ye(r,this.material),this.body.add(this.mesh),this.eyes=new ye(s,dg),this.body.add(this.eyes),this.root.add(this.body),this.shadow=fg(t),this.root.add(this.shadow),this.footprintDim=ha(t),this.displayScale=new Ye(this.trayScaleTarget()),this.root.scale.setScalar(this.displayScale.value),this.root.position.copy(n),this.target.copy(n),this.posSpring=new Ym(n.x,n.y,n.z)}setShape(t,e){const{geometry:n,eyeGeometry:r}=rl(t,e);this.mesh.geometry.dispose(),this.mesh.geometry=n,this.eyes.geometry.dispose(),this.eyes.geometry=r,this.shadow.geometry.dispose(),this.shadow.geometry=Ql(t),this.footprintDim=ha(t)}dispose(){this.mesh.geometry.dispose(),this.eyes.geometry.dispose(),this.material.dispose(),this.shadow.geometry.dispose()}trayScaleTarget(){return this.inTray?Math.min(1,Jl/this.footprintDim):1}setTrayMode(t){this.inTray=t}startDrag(t){this.held=!0,this.inTray=!1,this.posProfile=eg,this.target.copy(t),this.scaleUp.kick(.6),this.wobbleEnergy.kick(og)}dragTo(t){this.target.copy(t)}release(t,e){this.held=!1,this.target.copy(t),e?(this.posProfile=sl,this.scaleUp.kick(-2.75),this.scaleAlong.kick(1.25),this.scaleAcross.kick(1.25),this.wobbleEnergy.kick(.8),this.posSpring.y.kick(-1.8)):(this.posProfile=ng,this.inTray=!0,this.wobbleEnergy.kick(.3),this.posSpring.y.kick(-1.8*.5))}lock(){this.scaleUp.kick(-4),this.scaleAlong.kick(2.25),this.scaleAcross.kick(2.25),this.wobbleEnergy.kick(1)}update(t){Zm(t,lg,e=>this.substep(e)),this.writeTransform()}substep(t){this.time+=t,this.posSpring.step(this.target,t,this.posProfile.omega,this.posProfile.zeta);const e=this.posSpring.x.velocity,n=this.posSpring.z.velocity,r=Math.hypot(e,n),s=this.held?1+Math.min(r*rg,ig-1):1,o=1/Math.sqrt(s);this.scaleAlong.step(s,t,ci.omega,ci.zeta),this.scaleAcross.step(o,t,ci.omega,ci.zeta),this.scaleUp.step(this.held?1.08:1,t,ci.omega,ci.zeta);const a=new It(e,n).sub(new It(this.prevVelocity.x,this.prevVelocity.z));this.prevVelocity.set(e,0,n);const l=kn.clamp(-a.y*ol,-Ar,Ar),c=kn.clamp(a.x*ol,-Ar,Ar);this.tiltX.step(l,t,Tr.omega,Tr.zeta),this.tiltZ.step(c,t,Tr.omega,Tr.zeta),this.wobbleEnergy.kick(r*sg*t),this.wobbleEnergy.step(this.held?ag:0,t,al.omega,al.zeta),this.displayScale.step(this.trayScaleTarget(),t,cl.omega,cl.zeta)}writeTransform(){this.root.position.set(this.posSpring.x.value,this.posSpring.y.value,this.posSpring.z.value),this.root.scale.setScalar(Math.max(this.displayScale.value,.1)),this.body.rotation.set(this.tiltX.value,0,this.tiltZ.value),this.body.scale.set(Math.max(this.scaleAcross.value,.15),Math.max(this.scaleUp.value,.15),Math.max(this.scaleAlong.value,.15)),this.material.wobbleUniforms.uTime.value=this.time+this.timeOffset,this.material.wobbleUniforms.uWobbleAmp.value=Math.min(Math.abs(this.wobbleEnergy.value)*ll,ll)}}const hg=new Br({color:656914,transparent:!0,opacity:.32,depthWrite:!1}),dg=new Br({vertexColors:!0,toneMapped:!1});function Ql(i){const t=i.map(l=>l[0]),e=i.map(l=>l[1]),n=Math.max(...t)-Math.min(...t)+1,r=Math.max(...e)-Math.min(...e)+1,s=(Math.max(...t)+Math.min(...t))/2,o=(Math.max(...e)+Math.min(...e))/2,a=new ba(.5,16);return a.rotateX(-Math.PI/2),a.scale(n*.62,1,r*.62),a.translate(s,.005,o),a}function fg(i){return new ye(Ql(i),hg)}const pg=250,mg=12;class gg{listeners=[];active=null;constructor(t){t.addEventListener("pointerdown",this.onDown),window.addEventListener("pointermove",this.onMove),window.addEventListener("pointerup",this.onUp),window.addEventListener("pointercancel",this.onCancel)}on(t){return this.listeners.push(t),()=>{this.listeners=this.listeners.filter(e=>e!==t)}}emit(t){for(const e of this.listeners)e(t)}onDown=t=>{if(this.active)return;const e=t.target;this.active={pointerId:t.pointerId,startX:t.clientX,startY:t.clientY,startT:t.timeStamp,startTarget:e,dragging:!1}};onMove=t=>{const e=this.active;if(!e||t.pointerId!==e.pointerId)return;const n=t.clientX-e.startX,r=t.clientY-e.startY;if(!e.dragging){if(Math.hypot(n,r)<mg)return;e.dragging=!0,this.emit({type:"dragstart",point:{x:e.startX,y:e.startY},target:e.startTarget})}this.emit({type:"drag",point:{x:t.clientX,y:t.clientY}})};onUp=t=>{const e=this.active;if(!e||t.pointerId!==e.pointerId)return;this.active=null;const n={x:t.clientX,y:t.clientY};if(e.dragging){this.emit({type:"dragend",point:n});return}t.timeStamp-e.startT<=pg&&this.emit({type:"tap",point:n,target:e.startTarget})};onCancel=t=>{!this.active||t.pointerId!==this.active.pointerId||(this.active=null,this.emit({type:"dragcancel"}))}}class _g{levelValue;stuckBanner;overlay;overlayTitle;overlayBody;overlayAction;undoBtn;overlayCb;constructor(t,e){this.overlayCb=e,t.innerHTML="";const n=document.createElement("div");n.className="hud-top";const r=document.createElement("div");r.className="stat",r.innerHTML=`<span class="k">LEVEL</span><span class="value" id="level-value">1 / ${Wi}</span>`,n.appendChild(r),t.appendChild(n),this.levelValue=r.querySelector("#level-value");const s=document.createElement("div");s.className="tray-label",s.textContent="Drag or tap a cat, then tap the grid",t.appendChild(s),this.stuckBanner=document.createElement("div"),this.stuckBanner.id="stuck-banner",this.stuckBanner.innerHTML='🐾 No cat fits anywhere — undo a move or restart the level.<br/><button data-act="undo">Undo</button><button data-act="restart">Restart</button>',this.stuckBanner.addEventListener("click",a=>{const l=a.target.dataset.act;l==="undo"&&e.onUndo(),l==="restart"&&e.onRestart()}),t.appendChild(this.stuckBanner),this.overlay=document.createElement("div"),this.overlay.className="overlay hidden",this.overlay.innerHTML=`
      ...
      </div>`,t.appendChild(this.overlay),this.overlayTitle=this.overlay.querySelector("#overlay-title"),this.overlayBody=this.overlay.querySelector("#overlay-body"),this.overlayAction=this.overlay.querySelector("#overlay-action");const o=document.createElement("div");o.className="controls",o.innerHTML='<button class="ctl" data-act="undo">↩ Undo</button><button class="ctl" data-act="restart">⟲ Restart</button>',o.addEventListener("click",a=>{const l=a.target.closest("[data-act]")?.dataset.act;l==="undo"&&e.onUndo(),l==="restart"&&e.onRestart()}),t.appendChild(o),this.undoBtn=o.querySelector('[data-act="undo"]')}setLevel(t){this.levelValue.textContent=`${t} / ${Wi}`}setUndoEnabled(t){this.undoBtn.disabled=!t}showStuck(t){this.stuckBanner.classList.toggle("show",t)}showWon(t){this.overlayTitle.textContent="Level Clear!",this.overlayBody.textContent=`All ${t<Wi?t:Wi} cats tucked in. On to the next grid.`,this.overlayAction.textContent="Next Level",this.overlayAction.onclick=()=>this.overlayCb.onNextLevel(),this.overlay.classList.remove("hidden")}showComplete(){this.overlayTitle.textContent="All Levels Complete!",this.overlayBody.textContent="Every grid, fully tiled. You win Catris.",this.overlayAction.textContent="Play Again",this.overlayAction.onclick=()=>this.overlayCb.onPlayAgain(),this.overlay.classList.remove("hidden")}hideOverlay(){this.overlay.classList.add("hidden")}}const Rn=document.getElementById("game"),vg=document.getElementById("boot"),xg=document.getElementById("hud");Rn.style.touchAction="none";Rn.addEventListener("touchmove",i=>i.preventDefault(),{passive:!1});Rn.addEventListener("dragstart",i=>i.preventDefault());Rn.addEventListener("selectstart",i=>i.preventDefault());Rn.addEventListener("contextmenu",i=>i.preventDefault());document.addEventListener("gesturestart",i=>i.preventDefault());document.querySelectorAll("img,canvas").forEach(i=>i.setAttribute("draggable","false"));const tc=km(Rn),{renderer:Mg,scene:Ce,camera:Da}=tc;let Tt=new Zl(Date.now()%2147483647||1,1),Gn=new jl(Tt.board.width,Tt.board.height);Ce.add(Gn.mesh);function ul(i,t,e){const n=new I(i,t,e).project(Da),r=Rn.getBoundingClientRect();return{x:r.left+(n.x+1)/2*r.width,y:r.top+(1-n.y)/2*r.height}}window.__catrisDebug=()=>({game:Tt,lockedPositions:Ne.map(i=>i.root.position.toArray()),lockedBounds:Ne.map(i=>{i.mesh.geometry.computeBoundingBox();const t=i.mesh.geometry.boundingBox;return{min:t.min.toArray(),max:t.max.toArray()}}),lockedBodyRotationY:Ne.map(i=>i.body.rotation.y),lockedRootRotationY:Ne.map(i=>i.root.rotation.y),lockedRootScale:Ne.map(i=>i.root.scale.toArray()),hoverFootprint:un.map(i=>({...i})),lockedBodyScale:Ne.map(i=>i.body.scale.toArray()),screenPosForCell:(i,t)=>ul(i,0,t),screenPosForTraySlot:i=>{const t=La(Tt.board.width,Tt.board.height,i);return ul(t.x,t.y,t.z)},placementOriginForSlot:i=>{if(!Tt.pickUp(i))return null;for(let t=0;t<Tt.board.height;t++)for(let e=0;e<Tt.board.width;e++)if(Tt.canPlaceHeldAt(e,t))return Tt.putDown(),[e,t];return Tt.putDown(),null},tryLockSlot:(i,t,e)=>{if(!Tt.pickUp(i))return!1;const n=Tt.place(t,e);return n||Tt.putDown(),n}});const we=new Array(En).fill(null),xi=new Array(En).fill(null),Ne=[];let Ot=null,ve=null,un=[];function Sg(i,t){if(i.length!==t.length)return!1;for(let e=0;e<i.length;e++)if(i[e].x!==t[e].x||i[e].y!==t[e].y||i[e].valid!==t[e].valid)return!1;return!0}const Sn=new _g(xg,{onUndo:()=>Ag(),onRestart:()=>bg(),onNextLevel:()=>{Sn.hideOverlay(),Tt.advanceLevel(),Ir()},onPlayAgain:()=>{Sn.hideOverlay(),Tt=new Zl(Date.now()%2147483647||2,1),Ir()}});function ec(i,t,e,n){const[r,s]=Im(n),o=cg(n),a=La(i,t,e);return new I(a.x-r*o,a.y,a.z-s*o)}function nc(i,t){return`${i}:${t}`}function yg(i){for(let t=0;t<i.length;t++){const e=i[t];e&&(Ce.remove(e.root),e.dispose()),i[t]=null}}function Ir(){Ce.remove(Gn.mesh),Gn.dispose(),Gn=new jl(Tt.board.width,Tt.board.height),Ce.add(Gn.mesh),yg(we),xi.fill(null);for(const i of Ne)Ce.remove(i.root),i.dispose();Ne.length=0,Ot&&(Ce.remove(Ot.root),Ot.dispose(),Ot=null),ve=null,un=[],tc.frame(Tt.board.width,Tt.board.height),Nr()}function Eg(){const i=Tt.board.width,t=Tt.board.height;for(let e=0;e<En;e++){if(e===ve)continue;const n=Tt.tray[e];if(!n){we[e]&&(Ce.remove(we[e].root),we[e].dispose(),we[e]=null,xi[e]=null);continue}const r=nc(n.shapeId,n.paletteIndex);if(xi[e]!==r){we[e]&&(Ce.remove(we[e].root),we[e].dispose());const s=vi(n.shapeId,n.rotation),o=ec(i,t,e,s),a=new ug(s,Gr[n.paletteIndex],o);Ce.add(a.root),we[e]=a,xi[e]=r}}}function Nr(){Eg(),Gn.update((i,t)=>Tt.board.isFree(i,t),un),Sn.setLevel(Tt.level),Sn.setUndoEnabled(Tt.canUndo()),Sn.showStuck(Tt.status==="stuck"),Tt.status==="won"?Sn.showWon(Tt.level):Tt.status==="complete"?Sn.showComplete():Sn.hideOverlay()}function Tg(i){return new I(i[0],0,i[1])}function da(i){if(Tt.status!=="playing"||Ot!==null)return;const t=Tt.tray[i];!t||!Tt.pickUp(i)||(ve=i,Ot=we[i],we[i]=null,xi[i]=null,Ot?.setShape(vi(t.shapeId,t.rotation),Gr[t.paletteIndex]),Ot?.setTrayMode(!1))}function Mi(i){if(ve===null||!Ot)return;const t=Tt.board.width,e=Tt.board.height;if(i&&Tt.canPlaceHeldAt(i[0],i[1])){const s=Ot;Tt.place(i[0],i[1]),s.release(Tg(i),!0),s.lock(),Ne.push(s),Ot=null,ve=null,un=[],Nr();return}const n=Tt.tray[ve],r=n?ec(t,e,ve,vi(n.shapeId,n.rotation)):La(t,e,ve);Ot.release(r,!1),we[ve]=Ot,xi[ve]=n?nc(n.shapeId,n.paletteIndex):null,Tt.putDown(),Ot=null,ve=null,un=[],Nr()}function Ag(){if(Tt.canUndo()){if(Ot&&(Ce.remove(Ot.root),Ot.dispose(),Ot=null,ve=null),Ne.length>0){const i=Ne.pop();Ce.remove(i.root),i.dispose()}Tt.undo(),un=[],Nr()}}function bg(){Ot&&(Ce.remove(Ot.root),Ot.dispose(),Ot=null,ve=null),Tt.restartLevel(),Ir()}const hl=new Pm,wg=new Mn(new I(0,1,0),0);function kr(i,t){const e=Rn.getBoundingClientRect(),n=new It((i-e.left)/e.width*2-1,-((t-e.top)/e.height)*2+1);hl.setFromCamera(n,Da);const r=new I;if(!hl.ray.intersectPlane(wg,r))return{kind:"none",point:new I};const o=Tt.board.width,a=Tt.board.height,l=Pa(a);if(Math.abs(r.z-l)<.7){const d=(o-1)/2;let f=0,p=1/0;for(let g=0;g<En;g++){const M=Math.abs(r.x-(d+(g-1)*ua));M<p&&(p=M,f=g)}if(p<ua*.62)return{kind:"tray",traySlot:f,point:r}}const c=Math.round(r.x),u=Math.round(r.z);return c>=0&&c<o&&u>=0&&u<a?{kind:"grid",cell:[c,u],point:r}:{kind:"none",point:r}}const Rg=new gg(document.body);Rg.on(i=>{switch(i.type){case"tap":Cg(i.point);break;case"dragstart":Pg(i.point);break;case"drag":Lg(i.point);break;case"dragend":Dg(i.point);break;case"dragcancel":Ug();break}});function Cg(i){const t=kr(i.x,i.y);if(t.kind==="tray"&&t.traySlot!==void 0){Ot&&ve!==t.traySlot?(Mi(null),da(t.traySlot)):Ot||da(t.traySlot);return}if(t.kind==="grid"&&Ot){Mi(t.cell??null);return}Ot&&Mi(null)}function Pg(i){const t=kr(i.x,i.y);t.kind!=="tray"||t.traySlot===void 0||(Ot&&ve!==t.traySlot&&Mi(null),Ot||da(t.traySlot),Ot&&Ot.startDrag(t.point))}function Lg(i){if(!Ot)return;const t=kr(i.x,i.y);Ot.dragTo(t.point);let e=[];if(t.kind==="grid"&&t.cell){const r=Tt.heldFootprintAt(t.cell[0],t.cell[1]);r&&(e=r.cells.map(([s,o])=>({x:s,y:o,valid:r.valid})))}const n=!Sg(un,e);un=e,n&&Gn.update((r,s)=>Tt.board.isFree(r,s),un)}function Dg(i){if(!Ot)return;const t=kr(i.x,i.y);Mi(t.kind==="grid"?t.cell??null:null)}function Ug(){Ot&&Mi(null)}vg.style.display="none";Ir();let dl=performance.now();function ic(i){const t=Math.min((i-dl)/1e3,.1);dl=i;for(const e of we)e?.update(t);for(const e of Ne)e.update(t);Ot?.update(t),Mg.render(Ce,Da),requestAnimationFrame(ic)}requestAnimationFrame(ic);
