...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function nm(i,e,t){const n=new Float32Array(mi),s=new N(0,1,0);return new pn({name:"SphericalGaussianBlur",defines:{n:mi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Nr(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Yl(){return new pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Nr(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function $l(){return new pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nr(),fragmentShader:`
	...
	`}class sh extends En{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Jc(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new ti(5,5,5),r=new pn({name:"CubemapFromEquirect",uniforms:ts(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:qt,blending:Nn});r.uniforms.tEquirect.value=t;const a=new Yt(s,r),o=t.minFilter;return t.minFilter===_i&&(t.minFilter=Nt),new of(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function im(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,p=!1){return h==null?null:p?a(h):r(h)}function r(h){if(h&&h.isTexture){const p=h.mapping;if(p===Vr||p===Wr)if(e.has(h)){const x=e.get(h).texture;return o(x,h.mapping)}else{const x=h.image;if(x&&x.height>0){const S=new sh(x.height);return S.fromEquirectangularTexture(i,h),e.set(h,S),h.addEventListener("dispose",l),o(S.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const p=h.mapping,x=p===Vr||p===Wr,S=p===Mi||p===ji;if(x||S){let m=t.get(h);const d=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==d)return n===null&&(n=new Xl(i)),m=x?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const y=h.image;return x&&y&&y.height>0||S&&y&&c(y)?(n===null&&(n=new Xl(i)),m=x?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function o(h,p){return p===Vr?h.mapping=Mi:p===Wr&&(h.mapping=ji),h}function c(h){let p=0;const x=6;for(let S=0;S<x;S++)h[S]!==void 0&&p++;return p===x}function l(h){const p=h.target;p.removeEventListener("dispose",l);const x=e.get(p);x!==void 0&&(e.delete(p),x.dispose())}function u(h){const p=h.target;p.removeEventListener("dispose",u);const x=t.get(p);x!==void 0&&(t.delete(p),x.dispose())}function f(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:f}}function sm(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Ki("WebGLRenderer: "+n+" extension not supported."),s}}}function rm(i,e,t,n){const s={},r=new WeakMap;function a(f){const h=f.target;h.index!==null&&e.remove(h.index);for(const x in h.attributes)e.remove(h.attributes[x]);h.removeEventListener("dispose",a),delete s[h.id];const p=r.get(h);p&&(e.remove(p),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(f,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function c(f){const h=f.attributes;for(const p in h)e.update(h[p],i.ARRAY_BUFFER)}function l(f){const h=[],p=f.index,x=f.attributes.position;let S=0;if(x===void 0)return;if(p!==null){const y=p.array;S=p.version;for(let w=0,M=y.length;w<M;w+=3){const A=y[w+0],b=y[w+1],R=y[w+2];h.push(A,b,b,R,R,A)}}else{const y=x.array;S=x.version;for(let w=0,M=y.length/3-1;w<M;w+=3){const A=w+0,b=w+1,R=w+2;h.push(A,b,b,R,R,A)}}const m=new(x.count>=65535?Kc:$c)(h,1);m.version=S;const d=r.get(f);d&&e.remove(d),r.set(f,m)}function u(f){const h=r.get(f);if(h){const p=f.index;p!==null&&h.version<p.version&&l(f)}else l(f);return r.get(f)}return{get:o,update:c,getWireframeAttribute:u}}function am(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,h){i.drawElements(n,h,r,f*a),t.update(h,n,1)}function l(f,h,p){p!==0&&(i.drawElementsInstanced(n,h,r,f*a,p),t.update(h,n,p))}function u(f,h,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,f,0,p);let S=0;for(let m=0;m<p;m++)S+=h[m];t.update(S,n,1)}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u}function om(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Ge("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function lm(i,e,t){const n=new WeakMap,s=new lt;function r(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==f){let P=function(){_.dispose(),n.delete(o),o.removeEventListener("dispose",P)};var p=P;h!==void 0&&h.texture.dispose();const x=o.morphAttributes.position!==void 0,S=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],w=o.morphAttributes.color||[];let M=0;x===!0&&(M=1),S===!0&&(M=2),m===!0&&(M=3);let A=o.attributes.position.count*M,b=1;A>e.maxTextureSize&&(b=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const R=new Float32Array(A*b*4*f),_=new qc(R,A,b,f);_.type=fn,_.needsUpdate=!0;const E=M*4;for(let C=0;C<f;C++){const L=d[C],G=y[C],W=w[C],O=A*b*4*C;for(let q=0;q<L.count;q++){const k=q*E;x===!0&&(s.fromBufferAttribute(L,q),R[O+k+0]=s.x,R[O+k+1]=s.y,R[O+k+2]=s.z,R[O+k+3]=0),S===!0&&(s.fromBufferAttribute(G,q),R[O+k+4]=s.x,R[O+k+5]=s.y,R[O+k+6]=s.z,R[O+k+7]=0),m===!0&&(s.fromBufferAttribute(W,q),R[O+k+8]=s.x,R[O+k+9]=s.y,R[O+k+10]=s.z,R[O+k+11]=W.itemSize===4?s.w:1)}}h={count:f,texture:_,size:new Ne(A,b)},n.set(o,h),o.addEventListener("dispose",P)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let x=0;for(let m=0;m<l.length;m++)x+=l[m];const S=o.morphTargetsRelative?1:1-x;c.getUniforms().setValue(i,"morphTargetBaseInfluence",S),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function cm(i,e,t,n,s){let r=new WeakMap;function a(l){const u=s.render.frame,f=l.geometry,h=e.get(l,f);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==u&&(p.update(),r.set(p,u))}return h}function o(){r=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const hm={[Lc]:"LINEAR_TONE_MAPPING",[Ic]:"REINHARD_TONE_MAPPING",[Dc]:"CINEON_TONE_MAPPING",[bo]:"ACES_FILMIC_TONE_MAPPING",[Nc]:"AGX_TONE_MAPPING",[Fc]:"NEUTRAL_TONE_MAPPING",[Uc]:"CUSTOM_TONE_MAPPING"};function um(i,e,t,n,s,r){const a=new En(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new es(e,t):void 0}),o=new En(e,t,{type:On,depthBuffer:!1,stencilBuffer:!1}),c=new Rt;c.setAttribute("position",new ot([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new ot([0,2,0,0,2,0],2));const l=new ef({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Yt(c,l),f=new Ho(-1,1,1,-1,0,1);let h=null,p=null,x=!1,S,m=null,d=[],y=!1;this.setSize=function(w,M){a.setSize(w,M),o.setSize(w,M);for(let A=0;A<d.length;A++){const b=d[A];b.setSize&&b.setSize(w,M)}},this.setEffects=function(w){d=w,y=d.length>0&&d[0].isRenderPass===!0;const M=a.width,A=a.height;for(let b=0;b<d.length;b++){const R=d[b];R.setSize&&R.setSize(M,A)}},this.begin=function(w,M){if(x||w.toneMapping===yn&&d.length===0)return!1;if(m=M,M!==null){const A=M.width,b=M.height;(a.width!==A||a.height!==b)&&this.setSize(A,b)}return y===!1&&w.setRenderTarget(a),S=w.toneMapping,w.toneMapping=yn,!0},this.hasRenderPass=function(){return y},this.end=function(w,M){w.toneMapping=S,x=!0;let A=a,b=o;for(let R=0;R<d.length;R++){const _=d[R];if(_.enabled!==!1&&(_.render(w,b,A,M),_.needsSwap!==!1)){const E=A;A=b,b=E}}if(h!==w.outputColorSpace||p!==w.toneMapping){h=w.outputColorSpace,p=w.toneMapping,l.defines={},ze.getTransfer(h)===Ke&&(l.defines.SRGB_TRANSFER="");const R=hm[p];R&&(l.defines[R]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,w.setRenderTarget(m),w.render(u,f),m=null,x=!1},this.isCompositing=function(){return x},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const rh=new Ft,So=new es(1,1),ah=new qc,oh=new Cu,lh=new Jc,Kl=[],Zl=[],Jl=new Float32Array(16),Ql=new Float32Array(9),jl=new Float32Array(4);function ss(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Kl[s];if(r===void 0&&(r=new Float32Array(s),Kl[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function St(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function yt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Fr(i,e){let t=Zl[e];t===void 0&&(t=new Int32Array(e),Zl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function fm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function dm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2fv(this.addr,e),yt(t,e)}}function pm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;i.uniform3fv(this.addr,e),yt(t,e)}}function mm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4fv(this.addr,e),yt(t,e)}}function gm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),yt(t,e)}else{if(St(t,n))return;jl.set(n),i.uniformMatrix2fv(this.addr,!1,jl),yt(t,n)}}function _m(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),yt(t,e)}else{if(St(t,n))return;Ql.set(n),i.uniformMatrix3fv(this.addr,!1,Ql),yt(t,n)}}function xm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),yt(t,e)}else{if(St(t,n))return;Jl.set(n),i.uniformMatrix4fv(this.addr,!1,Jl),yt(t,n)}}function vm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Mm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2iv(this.addr,e),yt(t,e)}}function Sm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3iv(this.addr,e),yt(t,e)}}function ym(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4iv(this.addr,e),yt(t,e)}}function Em(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function bm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2uiv(this.addr,e),yt(t,e)}}function Tm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3uiv(this.addr,e),yt(t,e)}}function Am(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4uiv(this.addr,e),yt(t,e)}}function wm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(So.compareFunction=t.isReversedDepthBuffer()?Do:Io,r=So):r=rh,t.setTexture2D(e||r,s)}function Rm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||oh,s)}function Cm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||lh,s)}function Pm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||ah,s)}function Lm(i){switch(i){case 5126:return fm;case 35664:return dm;case 35665:return pm;case 35666:return mm;case 35674:return gm;case 35675:return _m;case 35676:return xm;case 5124:case 35670:return vm;case 35667:case 35671:return Mm;case 35668:case 35672:return Sm;case 35669:case 35673:return ym;case 5125:return Em;case 36294:return bm;case 36295:return Tm;case 36296:return Am;case 35678:case 36198:case 36298:case 36306:case 35682:return wm;case 35679:case 36299:case 36307:return Rm;case 35680:case 36300:case 36308:case 36293:return Cm;case 36289:case 36303:case 36311:case 36292:return Pm}}function Im(i,e){i.uniform1fv(this.addr,e)}function Dm(i,e){const t=ss(e,this.size,2);i.uniform2fv(this.addr,t)}function Um(i,e){const t=ss(e,this.size,3);i.uniform3fv(this.addr,t)}function Nm(i,e){const t=ss(e,this.size,4);i.uniform4fv(this.addr,t)}function Fm(i,e){const t=ss(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Om(i,e){const t=ss(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Bm(i,e){const t=ss(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function zm(i,e){i.uniform1iv(this.addr,e)}function km(i,e){i.uniform2iv(this.addr,e)}function Gm(i,e){i.uniform3iv(this.addr,e)}function Hm(i,e){i.uniform4iv(this.addr,e)}function Vm(i,e){i.uniform1uiv(this.addr,e)}function Wm(i,e){i.uniform2uiv(this.addr,e)}function Xm(i,e){i.uniform3uiv(this.addr,e)}function qm(i,e){i.uniform4uiv(this.addr,e)}function Ym(i,e,t){const n=this.cache,s=e.length,r=Fr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=So:a=rh;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function $m(i,e,t){const n=this.cache,s=e.length,r=Fr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||oh,r[a])}function Km(i,e,t){const n=this.cache,s=e.length,r=Fr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||lh,r[a])}function Zm(i,e,t){const n=this.cache,s=e.length,r=Fr(t,s);St(n,r)||(i.uniform1iv(this.addr,r),yt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||ah,r[a])}function Jm(i){switch(i){case 5126:return Im;case 35664:return Dm;case 35665:return Um;case 35666:return Nm;case 35674:return Fm;case 35675:return Om;case 35676:return Bm;case 5124:case 35670:return zm;case 35667:case 35671:return km;case 35668:case 35672:return Gm;case 35669:case 35673:return Hm;case 5125:return Vm;case 36294:return Wm;case 36295:return Xm;case 36296:return qm;case 35678:case 36198:case 36298:case 36306:case 35682:return Ym;case 35679:case 36299:case 36307:return $m;case 35680:case 36300:case 36308:case 36293:return Km;case 36289:case 36303:case 36311:case 36292:return Zm}}class Qm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Lm(t.type)}}class jm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Jm(t.type)}}class eg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Sa=/(\w+)(\])?(\[|\.)?/g;function ec(i,e){i.seq.push(e),i.map[e.id]=e}function tg(i,e,t){const n=i.name,s=n.length;for(Sa.lastIndex=0;;){const r=Sa.exec(n),a=Sa.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){ec(t,l===void 0?new Qm(o,i,e):new jm(o,i,e));break}else{let f=t.map[o];f===void 0&&(f=new eg(o),ec(t,f)),t=f}}}class xr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);tg(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function tc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const ng=37297;let ig=0;function sg(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const nc=new Le;function rg(i){ze._getMatrix(nc,ze.workingColorSpace,i);const e=`mat3( ${nc.elements.map(t=>t.toFixed(4))} )`;switch(ze.getTransfer(i)){case Ar:return[e,"LinearTransferOETF"];case Ke:return[e,"sRGBTransferOETF"];default:return Ce("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function ic(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}const og={[Lc]:"Linear",[Ic]:"Reinhard",[Dc]:"Cineon",[bo]:"ACESFilmic",[Nc]:"AgX",[Fc]:"Neutral",[Uc]:"Custom"};function lg(i,e){const t=og[e];return t===void 0?(Ce("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const or=new N;function cg(){ze.getLuminanceCoefficients(or);const i=or.x.toFixed(4),e=or.y.toFixed(4),t=or.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function hg(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(vs).join(`
`)}function ug(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function fg(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function vs(i){return i!==""}function sc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function rc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const dg=/^[ \t]*#include +<([\w\d./]+)>/gm;function yo(i){return i.replace(dg,mg)}const pg=new Map;function mg(i,e){let t=Fe[e];if(t===void 0){const n=pg.get(e);if(n!==void 0)t=Fe[n],Ce('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return yo(t)}const gg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ac(i){return i.replace(gg,_g)}function _g(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function oc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const xg={[dr]:"SHADOWMAP_TYPE_PCF",[_s]:"SHADOWMAP_TYPE_VSM"};function vg(i){return xg[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Mg={[Mi]:"ENVMAP_TYPE_CUBE",[ji]:"ENVMAP_TYPE_CUBE",[Dr]:"ENVMAP_TYPE_CUBE_UV"};function Sg(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Mg[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const yg={[ji]:"ENVMAP_MODE_REFRACTION"};function Eg(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":yg[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const bg={[Pc]:"ENVMAP_BLENDING_MULTIPLY",[lu]:"ENVMAP_BLENDING_MIX",[cu]:"ENVMAP_BLENDING_ADD"};function Tg(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":bg[i.combine]||"ENVMAP_BLENDING_NONE"}function Ag(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function wg(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=vg(t),l=Sg(t),u=Eg(t),f=Tg(t),h=Ag(t),p=hg(t),x=ug(r),S=s.createProgram();let m,d,y=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        }`});this.points=new $u(t,a),this.points.frustumCulled=!1,this.attr={material:a,pos:t.getAttribute("position"),col:t.getAttribute("aColor"),aux:t.getAttribute("aAux")},this.points.renderOrder=20,e.add(this.points)}setPixelRatio(e){const t=this.attr.material.uniforms.uPR;t.value!==e&&(t.value=e)}spawn(e,t,n,s){const r=this.head;this.head=(this.head+1)%ln;const a=s.boost??1;this.attr.pos.setXYZ(r,e,t,n),this.attr.col.setXYZ(r,s.color.r*a,s.color.g*a,s.color.b*a),this.vel[r*3]=s.vx??0,this.vel[r*3+1]=s.vy??0,this.vel[r*3+2]=s.vz??0,this.life[r]=this.span[r]=s.life??1,this.grav[r]=s.gravity??0,this.wander[r]=s.wander??0,this.seedPhase[r]=this.rnd()*Math.PI*2,this.attr.aux.setXY(r,s.size??.09,1)}burst(e,t,n,s,r,a=2.4,o=2.2,c){const l=c?.sizeMin??.06,u=c?.sizeMax??.16;for(let f=0;f<r;f++){const h=this.rnd,p=h()*Math.PI*2,x=Math.acos(2*h()-1),S=a*(.45+.55*h());this.spawn(e,t,n,{color:s[h()*s.length|0],boost:c?.boost,size:l+h()*(u-l),life:.55+h()*.55,vx:Math.sin(x)*Math.cos(p)*S,vy:Math.cos(x)*S*.65+o*(.5+h()*.5),vz:Math.sin(x)*Math.sin(p)*S,gravity:4.2})}}flash(e,t,n,s){this.spawn(e,t,n,{color:s,boost:1.1,size:.7,life:.25,gravity:0})}poof(e,t,n,s,r){for(let a=0;a<r;a++){const o=this.rnd,c=o()*Math.PI*2,l=.5+o()*.9;this.spawn(e,t,n,{color:s,size:.05+o()*.06,life:.4+o()*.35,vx:Math.cos(c)*l,vy:.8+o()*.9,vz:Math.sin(c)*l,gravity:2.2})}}ambient(e,t,n,s,r){this.spawn(e,t,n,{color:s,...r})}update(e,t){const{pos:n,aux:s,col:r}=this.attr;let a=0;for(let o=0;o<ln;o++){if(this.life[o]<=0){s.setY(o,0);continue}if(this.life[o]-=e,this.life[o]<=0){s.setY(o,0);continue}a++;const c=this.wander[o];if(c>0){const f=this.seedPhase[o];this.vel[o*3]+=Math.sin(t*.9+f)*c*e,this.vel[o*3+2]+=Math.cos(t*1.13+f*1.7)*c*e,this.vel[o*3+1]+=Math.sin(t*1.4+f*.6)*c*.4*e}this.vel[o*3+1]-=this.grav[o]*e,n.setXYZ(o,n.getX(o)+this.vel[o*3]*e,n.getY(o)+this.vel[o*3+1]*e,n.getZ(o)+this.vel[o*3+2]*e);const l=this.life[o]/this.span[o];s.setY(o,Math.min(1,l*2.2));const u=s.getX(o);l<.3&&s.setX(o,u*(1-e*2.4))}this.aliveCount=a,n.needsUpdate=!0,s.needsUpdate=!0,r.needsUpdate=!0}}const gs=220,Kn=new Je,vr=new ni,Ea=new Tn,zt=new N,Ss=new N;class T0{constructor(e){ee(this,"mesh");ee(this,"vel",new Float32Array(gs*3));ee(this,"spin",new Float32Array(gs));ee(this,"phase",new Float32Array(gs));ee(this,"activeTarget",0);ee(this,"active",0);ee(this,"kind","rain");ee(this,"rnd",Or(4711));ee(this,"bounds",{x:5.4,y0:5.2,y1:8.2,z:4.4});ee(this,"killY",.03);ee(this,"killX",6.2);const t=new ti(.012,.24,.012),n=new yi({color:12572908,transparent:!0,opacity:.5,depthWrite:!1});this.mesh=new cn(t,n,gs),this.mesh.instanceMatrix.setUsage(Wc),this.mesh.frustumCulled=!1,this.mesh.renderOrder=15,e.add(this.mesh),this.setKind("rain")}setKind(e){if(e==="off"){this.activeTarget=0;return}this.kind=e;const t=this.mesh.material;e==="rain"?(t.color.setHex(12572908),t.opacity=.5,this.killY=.03,this.killX=6.2):(t.color.setHex(10473058),t.opacity=.85,this.killY=-.4,this.killX=6.2),this.respawnAll()}respawn(e,t=!1){const n=this.rnd;this.kind==="rain"?(zt.set((n()*2-1)*this.bounds.x,this.bounds.y0+n()*(this.bounds.y1-this.bounds.y0),(n()*2-1)*this.bounds.z),this.vel[e*3]=.55,this.vel[e*3+1]=-(7.2+n()*2.4),this.vel[e*3+2]=-.22,this.spin[e]=0):(zt.set(-this.bounds.x-n()*1.5,.3+n()*2.6,(n()*2-1)*this.bounds.z),this.vel[e*3]=1.8+n()*2.4,this.vel[e*3+1]=0,this.vel[e*3+2]=(n()-.5)*.8,this.spin[e]=(n()*2-1)*6),t&&this.kind==="rain"&&(zt.y=n()*this.bounds.y1),this.phase[e]=n()*Math.PI*2,Kn.compose(zt,vr.identity(),Ss.set(1,1,1)),this.mesh.setMatrixAt(e,Kn)}respawnAll(){for(let e=0;e<gs;e++)this.respawn(e,!0);this.mesh.instanceMatrix.needsUpdate=!0}get instance(){return this.mesh}update(e,t){const n=this.activeTarget;this.active<n&&(this.active=Math.min(n,this.active+e*260)),this.active>n&&(this.active=Math.max(n,this.active-e*340));const s=Math.floor(this.active);if(this.mesh.count=s,s===0){this.mesh.instanceMatrix.needsUpdate=!0;return}for(let r=0;r<s;r++)this.mesh.getMatrixAt(r,Kn),zt.setFromMatrixPosition(Kn),this.kind==="leaf"&&(zt.y+=Math.sin(t*2.1+this.phase[r])*.55*e,zt.z+=Math.cos(t*1.4+this.phase[r])*.4*e),zt.x+=this.vel[r*3]*e,zt.y+=this.vel[r*3+1]*e,zt.z+=this.vel[r*3+2]*e,zt.y<this.killY||zt.x>this.killX||zt.x<-this.killX-2.5?this.respawn(r):(this.kind==="leaf"?Ea.set(this.spin[r]*t+this.phase[r],this.phase[r]*2,this.spin[r]*.7*t):Ea.set(.02,0,-.075),vr.setFromEuler(Ea),this.kind==="leaf"?Ss.set(2.6,.55,2.6):Ss.set(1,1,1),Kn.compose(zt,vr,Ss),this.mesh.setMatrixAt(r,Kn));this.mesh.instanceMatrix.needsUpdate=!0,this.mesh.material.visible=s>0}}const hi=10;class A0{constructor(e){ee(this,"mesh");ee(this,"life",new Float32Array(hi));ee(this,"span",new Float32Array(hi));ee(this,"head",0);ee(this,"base",new Float32Array(hi*3));const t=new Is(.32,.42,40);t.rotateX(-Math.PI/2);const n=new yi({color:16771488,transparent:!0,opacity:.85,blending:Ji,depthWrite:!1,side:jt});this.mesh=new cn(t,n,hi),this.mesh.instanceMatrix.setUsage(Wc),this.mesh.frustumCulled=!1,this.mesh.count=0,this.mesh.renderOrder=14,e.add(this.mesh)}fire(e,t,n,s=1){const r=this.head;this.head=(this.head+1)%hi,this.life[r]=this.span[r]=.5+.25*s,this.base[r*3]=e,this.base[r*3+1]=t,this.base[r*3+2]=n}update(e){let t=0;for(let n=0;n<hi;n++){if(this.life[n]<=0||(this.life[n]-=e,this.life[n]<=0))continue;const r=.5+(1-this.life[n]/this.span[n])*2.6;Kn.compose(zt.set(this.base[n*3],this.base[n*3+1]+.012,this.base[n*3+2]),vr.identity(),Ss.set(r,1,r)),this.mesh.setMatrixAt(t++,Kn)}this.mesh.count=t,this.mesh.instanceMatrix.needsUpdate=!0,this.mesh.material.opacity=.85*Math.max(.001,...Array.from({length:hi},(n,s)=>this.life[s]>0?this.life[s]/this.span[s]:0))}}const w0=new ye("#9fe8ff"),R0=new ye("#ffbe5c"),vc=["#ff9fb8","#ffd761","#9fe8ff","#c9a5ff","#b8ff9f"].map(i=>new ye(i)),Mc=new ye("#ffe9b8");class C0{constructor(e){ee(this,"sparkles");ee(this,"streaks");ee(this,"waves");ee(this,"mood");ee(this,"rays",null);ee(this,"raysMat",null);ee(this,"rnd",Or(424243));ee(this,"spawnAcc",0);ee(this,"scale",1);ee(this,"world");ee(this,"garden",null);this.world=e,this.sparkles=new b0(e.scene),this.streaks=new T0(e.scene),this.waves=new A0(e.scene),this.mood=xc("sunny"),this.setMood(this.mood),e.onQualityDrop=t=>{this.scale=t===1?.6:.35}}bindGarden(e){this.garden=e,this.garden.setSwayAmp(this.mood.swayAmp)}setMood(e){this.mood=e,this.world.applyMood(e);const t=this.world.reducedMotion;this.garden?.setSwayAmp(t?0:e.swayAmp),this.garden?.setNightHalo(e.stars||e.hemiIntensity+e.sunIntensity<1.6),t?this.streaks.setKind("off"):e.particleMode==="rain"?(this.streaks.setKind("rain"),this.streaks.activeTarget=190):e.particleMode==="leaves"?(this.streaks.setKind("leaf"),this.streaks.activeTarget=52):this.streaks.setKind("off"),this.buildRays(e.godRays&&!t,e.rayColor);const n=document.querySelector("#garden-wrap");n&&n.style.setProperty("--vignette",e.vignette)}setWeatherId(e){this.setMood(xc(e))}buildRays(e,t){if(this.rays&&(this.world.scene.remove(this.rays),this.rays.geometry.dispose(),this.raysMat?.dispose(),this.rays=null,this.raysMat=null),!e)return;const n=7,s=[],r=-7.5,a=9.5,o=-4.5;for(let l=0;l<n;l++){const u=l/n*.52-.26,f=.045,h=r,p=a,x=o,S=r+Math.cos(u-f)*13,m=0,d=o+Math.sin(u-f)*9,y=r+Math.cos(u+f)*13,w=0,M=o+Math.sin(u+f)*9;s.push(h,p,x,S,m,d,y,w,M)}const c=new Rt;c.setAttribute("position",new Ot(new Float32Array(s),3)),this.raysMat=new yi({color:t,transparent:!0,opacity:.1,blending:Ji,depthWrite:!1,side:jt}),this.rays=new Yt(c,this.raysMat),this.rays.renderOrder=12,this.world.scene.add(this.rays)}splashBurst(){const e=this.rnd,t=(e()*2-1)*3.6,n=(e()*2-1)*2.6;this.sparkles.ambient(t,.06,n,new ye("#bfd8ec"),{size:.035+e()*.03,life:.28,vx:(e()-.5)*.6,vy:.7+e()*.5,vz:(e()-.5)*.6,gravity:4})}update(e,t){if(this.streaks.update(e,t),this.waves.update(e),this.sparkles.setPixelRatio(this.world.renderer.getPixelRatio()),!this.world.reducedMotion){const n=this.rnd,s=this.mood.particleMode;let r=0,a=Mc,o=3,c=.05,l=0,u=0,f=3.4,h=3.2,p=.05;for(s==="motes"?(r=2.2,a=Mc,o=4.2,c=.05,h=2.6,u=.05):s==="fireflies"?(r=1.4,a=w0,o=7,c=.075,l=.5,u=.02,h=.5):s==="sunRays"?(r=1.8,a=R0,o=4.6,c=.06,h=2.4):s==="petals"?(r=3.4,o=5,c=.075,h=3.4,u=-.25,p=.25):s==="rain"&&(r=0,Math.floor(t*14)!==Math.floor((t-e)*14)&&(this.splashBurst(),n()<.5&&this.splashBurst())),this.spawnAcc+=e*r*this.scale;this.spawnAcc>=1;){this.spawnAcc-=1;const x=s==="petals"?vc[n()*vc.length|0]:a;this.sparkles.ambient((n()*2-1)*f,h+n()*1.4,(n()*2-1)*(f*.7),x,{size:c*(.7+n()*.7),life:o*(.7+n()*.6),vx:(n()-.5)*.16,vy:u+(n()-.5)*.1,vz:(n()-.5)*.16,gravity:p,wander:l})}}this.rays&&(this.rays.rotation.y=Math.sin(t*.05)*.24,this.raysMat&&(this.raysMat.opacity=.085+.035*Math.sin(t*.4))),this.sparkles.update(e,t)}}const Ze=new Oh(P0());function P0(){try{return localStorage.setItem("__pgt","1"),localStorage.removeItem("__pgt"),localStorage}catch{return null}}document.title="Pocket Garden — jeez.games";const L0=document.getElementById("app");L0.innerHTML=`
  <header class="top">
    <div class="brand"><span class="brand-mark">${kh}</span>Pocket Garden</div>
...
`;const Et=i=>document.getElementById(i),I0=Et("garden-wrap"),Sc=Et("coins"),Pr=Et("picker"),Vo=Et("offline"),$n=Et("toast"),D0=Et("floaters");let Ye=null,st=null,Qn=null;try{Ye=new l0(I0),Qn=new C0(Ye),st=new S0({world:Ye,sparkles:Qn.sparkles,waves:Qn.waves}),st.attachLabels(Et("garden-labels")),Qn.bindGarden(st),st.reducedMotion=Ye.reducedMotion}catch(i){console.error("WebGL boot failed:",i),Et("gl-fail").classList.remove("hidden")}function uh(){const{def:i,seedId:e}=Sr(new Date),t=hn.get(e),n=i.id==="golden"?"+1 yield":"+25%&nbsp;faster",s=Et("weather");s.className=`weather weather--${i.id}`,s.innerHTML=`<span class="w-ico">${At(Bh[i.id]??"sun")}</span><b>${i.name}</b><span class="fx">${Ir(t.id)} ${t.name} ${n}</span>`,Qn?.setWeatherId(i.id)}let Es=-1,Mr=null;function vi(){st?.syncFromState(Ze.state,Es)}function U0(i){const e=Ze.state.unlockedPlots;if(i<e)return null;const t=e-Xi;return t<0||t>=Ts.length?null:i===e?Ts[t]:null}function N0(i){Cc();const e=Ze.state.plots[i],t=st?.plotScreenPos(i)??{x:window.innerWidth/2,y:window.innerHeight/2};if(i>=Ze.state.unlockedPlots){if(U0(i)==null){Yi("Unlock the plot before this one first",At("lock"));return}Es===i?(F0(),Ze.unlockNextPlot().ok?(gi.unlock(),Yi("New plot unlocked!",At("sprout")),st?.unlockFx(i),vi(),Ds()):Yi("Not enough coins",At("coin"))):(Es=i,vi(),Mr=window.setTimeout(()=>{Es=-1,vi()},3e3));return}if(e.status==="empty"){fh(i);return}if(e.status==="growing"){const r=hn.get(e.seedId);Yi(`${r.name} — ready in ${Er(e.growthTimeMs-e.progressMs)}`,Ir(r.id),!0);return}const n=Ze.harvest(i);if(!n.ok)return;gi.harvest();const s=(n.earnings??[]).reduce((r,a)=>Math.max(r,a.mult),1);st?.harvestFx(i,s),s>=50?(gi.jackpot(),Ta("rainbow",n.earned)):s>=10?(gi.jackpot(),Ta("golden",n.earned)):s>=5&&Ta("silver",n.earned),gh(t,`${At("coin")}+${jn(n.earned)}`),vi(),Ds()}function F0(){Es=-1,Mr!==null&&(window.clearTimeout(Mr),Mr=null)}let bs=-1;function fh(i){bs=i,dh(),Pr.classList.remove("hidden")}function zr(){Pr.classList.add("hidden"),bs=-1}function dh(){const i=Et("seed-list");i.innerHTML="";for(const e of As){const t=Ze.state.coins>=e.cost,n=Ze.state.selectedSeed===e.id,s=document.createElement("button");s.className="seed-row"+(n?" selected":"")+(t?"":" cant"),s.innerHTML=`
      ...
      <span class="s-info"><b>${e.name}</b>
        <small>
          ...
          <span class="m">${At("clock")}${Er(e.growthMs)}</span>
          <span class="m">sells ${jn(e.sellValue)} ×${e.yield}</span>
        </small>
      </span>
      <span class="s-go">${n?At("check")+"Yours":t?"Plant":At("lock")+"Locked"}</span>`,s.addEventListener("click",()=>{if(Ze.setSelectedSeed(e.id),ph(),bs>=0){const r=Ze.plantSeed(bs,e.id);if(r.ok){gi.plant(),st?.plantFx(bs),vi(),Ds(),zr();return}Yi(r.reason==="coins"?"Not enough coins":"Cannot plant there",At("coin"))}dh()}),i.appendChild(s)}}function Ds(){Sc.textContent=jn(Ze.state.coins);const i=Sc.parentElement;i&&(i.classList.remove("coin-bump"),i.offsetWidth,i.classList.add("coin-bump"))}function ph(){const i=hn.get(Ze.state.selectedSeed);Et("seeds-btn").innerHTML=`<span class="chip-art">${Ir(i.id)}</span><span class="chip-info"><span class="t">Plant</span><span class="n">${i.name} ${At("coin")} ${jn(i.cost)}</span></span><span class="chip-caret">${At("chevronUp")}</span>`}function mh(){const i=Et("mute");i.innerHTML=Ze.state.muted?yr.soundOff:yr.soundOn,i.setAttribute("aria-pressed",String(Ze.state.muted))}function gh(i,e){const t=document.createElement("div");t.className="floater",t.innerHTML=e,t.style.left=`${i.x}px`,t.style.top=`${i.y}px`,D0.appendChild(t),window.setTimeout(()=>t.remove(),1400)}const O0={silver:{label:"SILVER CROP!",art:Hr.silver,cls:"jp-silver",parts:["#dfe9f5","#bcd2ec","#ffffff","#a9bdd6"]},golden:{label:"GOLDEN CROP!",art:Hr.golden,cls:"jp-golden",parts:["#ffd45e","#f2b233","#fff0b8","#eab543"]},rainbow:{label:"RAINBOW CROP!!",art:Hr.rainbow,cls:"jp-rainbow",parts:["#ff6dd6","#ffd45e","#6dff9e","#5ec8ff","#c58cff","#ffffff"]}};let ba=null;function Ta(i,e){const t=Et("jackpot"),n=Et("jackpot-inner"),s=O0[i];n.className=`jp-burst ${s.cls}`,n.style.setProperty("--n",String(s.parts.length)),n.innerHTML=`
    <div class="jp-rays"></div>
    <div class="jp-emoji">${s.art}</div>
    <div class="jp-label">${s.label}</div>
    <div class="jp-coins">${At("coin")}+${jn(e)}</div>
    ${s.parts.map((r,a)=>`<span class="jp-part" style="--i:${a}; --pc:${r}">${At("sparkle")}</span>`).join("")}`,t.classList.remove("hidden"),ba!==null&&window.clearTimeout(ba),ba=window.setTimeout(()=>t.classList.add("hidden"),i==="rainbow"?2600:1800)}let Aa=null;function Yi(i,e=null,t=!1){if($n.innerHTML="",e){const s=document.createElement("span");s.className=t?"tt-crop":"tt-ico",s.innerHTML=e,$n.appendChild(s)}const n=document.createElement("span");n.textContent=i,$n.appendChild(n),$n.classList.remove("hidden"),$n.style.animation="none",$n.offsetWidth,$n.style.animation="",Aa!==null&&window.clearTimeout(Aa),Aa=window.setTimeout(()=>$n.classList.add("hidden"),1800)}function B0(i,e){Et("offline-text").textContent=e>0?`${Er(i)} away — ${e} crop${e===1?"":"s"} matured while you were gone. Go harvest!`:`${Er(i)} away — nothing matured yet. Plant something!`,Vo.classList.remove("hidden")}const fr=Ze.boot();wc(Ze.state.muted);vi();Ds();ph();mh();uh();st?.startBootStagger();Ze.onChange(()=>{Ds()});let yc=new Date().getUTCDate();window.setInterval(()=>{const i=new Date().getUTCDate();i!==yc&&(yc=i,uh(),Yi("The weather changed!",At("wind")))},3e4);let Ec=Date.now();window.setInterval(()=>{const i=Date.now();let e=i-Ec;Ec=i,e<0&&(e=0),e>qi&&(e=qi);const t=Ze.advance(e);for(const n of t){gi.ready();const s=st?.plotScreenPos(n.plot)??{x:window.innerWidth/2,y:window.innerHeight/3};gh(s,`${At("sprout")} Ready!`),st?.matureFx(n.plot)}t.length&&vi()},Rh);Ze.startAutoSave();window.addEventListener("pagehide",()=>Ze.commit());document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ze.commit()});window.addEventListener("beforeunload",()=>Ze.commit());Et("mute").addEventListener("click",()=>{const i=!Ze.state.muted;Ze.setMuted(i),wc(i),mh(),i||gi.coin()});Et("seeds-btn").addEventListener("click",()=>{Cc(),fh(-1)});Et("picker-close").addEventListener("click",zr);Pr.addEventListener("click",i=>{i.target===Pr&&zr()});Et("offline-ok").addEventListener("click",()=>Vo.classList.add("hidden"));document.addEventListener("keydown",i=>{i.key==="Escape"&&(zr(),Vo.classList.add("hidden"))});fr&&fr.elapsedMs>6e4&&B0(fr.elapsedMs,fr.grown);let bc=performance.now(),Tc=!1;function _h(i){const e=Math.min(.1,(i-bc)/1e3);bc=i;const t=i/1e3;Ye&&st&&Qn&&(Tc||(st.stampIntroClock(t),Tc=!0),st.update(e,t,t),Qn.update(e,t),Ye.updateCamera(t),Ye.sample(e,t),Ye.render()),requestAnimationFrame(_h)}requestAnimationFrame(_h);requestAnimationFrame(()=>document.getElementById("boot")?.remove());Ye&&st&&Ye.canvas.addEventListener("click",e=>{if(Ye.wasDrag())return;const t=st.tapAt(e.clientX,e.clientY);t>=0&&N0(t)});function z0(i){return i.canvas.getBoundingClientRect().height}window.__pg={ready:()=>!!Ye,drawCalls:()=>Ye?.renderer.info.render.calls??0,tris:()=>Ye?.renderer.info.render.triangles??0,coins:()=>Ze.state.coins,unlockedPlots:()=>Ze.state.unlockedPlots,weather:()=>Sr(new Date).def.id,qualityTier:()=>Ye?.qualityTier??-1,plots:()=>Ze.state.plots.map((i,e)=>({i:e,seedId:i.seedId,status:i.status,stage:st?st.currentVisual(e):0})),readyPlots:()=>Ze.state.plots.map((i,e)=>i.status==="ready"?e:-1).filter(i=>i>=0),plotScreenPos:i=>st?.plotScreenPos(i)??null,liveBursts:()=>Qn?.sparkles.aliveCount??0,burstTest:(i,e=1)=>st?.harvestFx(i,e),perf:()=>Ye?.perfStats()??null,resetPerf:()=>Ye?.resetPerf(),state:()=>Ze.state,hueScan:(i,e=42)=>{if(!Ye||!st)return null;Ye.updateCamera(performance.now()/1e3),Ye.render();const t=Ye.renderer.getContext(),n=t.drawingBufferWidth,s=t.drawingBufferHeight,r=new Uint8Array(n*s*4);t.readPixels(0,0,n,s,t.RGBA,t.UNSIGNED_BYTE,r);const a=new Array(i.length).fill(0);for(let o=0;o<n*s;o+=7){const c=o*4,l=r[c],u=r[c+1],f=r[c+2];for(let h=0;h<i.length;h++){const[p,x,S]=i[h];if(Math.abs(l-p)<=e&&Math.abs(u-x)<=e&&Math.abs(f-S)<=e){a[h]++;break}}}return a},plotProbe:(i,e=14)=>{if(!Ye||!st)return null;Ye.updateCamera(performance.now()/1e3),Ye.render();const t=st.plotScreenPos(i);if(!t)return null;t.y-=z0(Ye)*.06;const n=Ye.renderer.getContext(),s=Ye.canvas.getBoundingClientRect(),r=(t.x-s.left)/s.width*n.drawingBufferWidth,a=n.drawingBufferHeight-(t.y-s.top)/s.height*n.drawingBufferHeight,o=new Uint8Array(4),c=new Map,l=Math.floor(e/2);for(let u=-l;u<=l;u+=3)for(let f=-l;f<=l;f+=3){const h=Math.round(r)+f,p=Math.round(a)+u;if(h<0||p<0||h>=n.drawingBufferWidth||p>=n.drawingBufferHeight)continue;n.readPixels(h,p,1,1,n.RGBA,n.UNSIGNED_BYTE,o);const x=`${o[0]>>4},${o[1]>>4},${o[2]>>4}`;c.set(x,(c.get(x)??0)+1)}return[...c.entries()].map(([u,f])=>({c:u,n:f})).sort((u,f)=>f.n-u.n).slice(0,6)},screenSample:()=>{if(!Ye||!st)return null;Ye.updateCamera(performance.now()/1e3),Ye.render();const i=Ye.renderer.getContext(),e=i.drawingBufferWidth,t=i.drawingBufferHeight,n=[],s=new Uint8Array(4);for(let r=0;r<6;r++)for(let a=0;a<6;a++)i.readPixels(Math.round((a+.5)*e/6),Math.round((r+.5)*t/6),1,1,i.RGBA,i.UNSIGNED_BYTE,s),n.push([s[0],s[1],s[2]]);return n}};
